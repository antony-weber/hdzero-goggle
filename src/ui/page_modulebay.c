...
static lv_obj_t *page_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    btn_module_type = create_dropdown_item(cont, "Unknown\nSwitch\nrapidFIRE\nSteadyview\nSteadyview-X", 2, 0, 240, 40, 1, 4, LV_GRID_ALIGN_START, &lv_font_montserrat_26);

    // settings/mode menu entries
    lbl_module_mode = create_label_item(cont, "Mode", 1, 1, 1);
    btn_module_mode = create_dropdown_item(cont, "None", 2, 1, 240, 40, 1, 4, LV_GRID_ALIGN_START, &lv_font_montserrat_26);
